...
class GPIB_Address_Frame(Gui_Label_Frame):
    ...
    def update_pc_controller(self, event):
        ...
        self.master.master.master.preferences['connection']['gpib']['pc_controller'] = event.widget.get()


    def update_m750_device(self, event):

        self.master.master.master.preferences['connection']['gpib']['m750_device'] = event.widget.get()