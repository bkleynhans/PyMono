...
class Template3_Frame(Gui_Label_Frame):

    # connection Frame constructor
    def __init__(self, root, master):

        Gui_Label_Frame.__init__(self, root, master, "template3_frame", "Frame Title")

        self.master = master

        self.create_template3_frame(master)


    # Create the actual frame as a separate window
    def create_template3_frame(self, master):
